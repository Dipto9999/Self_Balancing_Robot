...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(GPIOA, DISTANCE_SENSOR_FRONT_INPUT_CAPTURE_Pin|DISTANCE_SENSOR_PULSE_Pin);

    HAL_GPIO_DeInit(DISTANCE_SENSOR_BACK_INPUT_CAPTURE_GPIO_Port, DISTANCE_SENSOR_BACK_INPUT_CAPTURE_Pin);
