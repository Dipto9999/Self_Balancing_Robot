...
int main(void)
{
  ...
  //DistanceSensor_Init(&Back, &htim3, TIM_CHANNEL_1, TIM_CHANNEL_2, TIM_FLAG_CC3);
  /* USER CODE END 2 */
  ...
  while (1)
  {
	...
	//__HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_2, (uint16_t) __HAL_TIM_GET_COUNTER(&htim3) + 1000);
