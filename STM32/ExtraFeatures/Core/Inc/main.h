...
/* Private defines -----------------------------------------------------------*/
#define DISTANCE_SENSOR_FRONT_INPUT_CAPTURE_Pin GPIO_PIN_0
#define DISTANCE_SENSOR_FRONT_INPUT_CAPTURE_GPIO_Port GPIOA
#define DISTANCE_SENSOR_FRONT_PULSE_Pin GPIO_PIN_1
#define DISTANCE_SENSOR_FRONT_PULSE_GPIO_Port GPIOA
#define DISTANCE_SENSOR_BACK_INPUT_CAPTURE_Pin GPIO_PIN_2
#define DISTANCE_SENSOR_BACK_INPUT_CAPTURE_GPIO_Port GPIOA
#define DISTANCE_SENSOR_BACK_PULSE_Pin GPIO_PIN_3
